...
<!-- Mirrored from www.themezaa.com/html/pofo/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Aug 2018 08:39:40 GMT -->
<head>
        <!-- title -->
                                    ...
                                    <div class="equalize sm-equalize-auto blog-post-content margin-60px-bottom padding-60px-bottom display-inline-block border-bottom border-color-extra-light-gray sm-margin-30px-bottom sm-padding-30px-bottom xs-text-center sm-no-border">
                                        <div class="blog-image col-md-5 no-padding sm-margin-30px-bottom xs-margin-20px-bottom margin-45px-right sm-no-margin-right display-table">
                                            <div class="display-table-cell vertical-align-middle">
                                                <a href="blog-standard-post.html"><img src="<?php  echo $row['image'];?>" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="blog-text col-md-6 display-table no-padding">
                                            <div class="display-table-cell vertical-align-middle">
                                                <div class="content margin-20px-bottom sm-no-padding-left ">
                                                    <a href="blog-standard-post.html" class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 display-inline-block">   
                                                        <?php  echo $row['title'];?>                        
                                                    </a>
                                                    <div class="text-medium-gray text-extra-small margin-15px-bottom text-uppercase alt-font"><span>By <a href="blog-grid.html" class="text-medium-gray"><?php  echo $row['author'];?></a></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span><?php  echo $row['date'];?></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="blog-grid.html" class="text-medium-gray"><?php  echo $row['category'];?></a></div>
                                                    <p class="no-margin width-95"><?php  echo $row['content'];?></p>
                                                </div>
