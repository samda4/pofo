...
<html class="no-js" lang="en">
   <!-- Mirrored from www.themezaa.com/html/pofo/home-blog-personal.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Aug 2018 08:06:34 GMT -->
   <head>
      <!-- title -->
                     ...
                     <div class="navbar-collapse collapse pull-right" id="navbar-collapse-toggle-1">
                        <ul id="accordion" class="nav navbar-nav navbar-left no-margin alt-font text-normal" data-in="fadeIn" data-out="fadeOut">
                           ...
                           <li class="dropdown simple-dropdown">
                              <a href="javascript:void(0);">Pages</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                              <!-- start sub menu -->
                              <ul class="dropdown-menu" role="menu">
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">About <i class="fas fa-angle-right"></i></a>
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Services <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Contact <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Team <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Additional Pages <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                           ...
                           <li class="dropdown simple-dropdown">
                              <a href="javascript:void(0);" title="Blog">Blog</a><i class="fas fa-angle-down dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i>
                              <!-- start sub menu -->
                              <ul class="dropdown-menu" role="menu">
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Standard <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Classic <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog List <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Grid <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Masonry <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Simple <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Clean <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Images <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Blog Only Text <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Post Layout <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Post Types <i class="fas fa-angle-right"></i></a>
                                    <ul class="dropdown-menu">
                     ...
                     <li class="grid-item wow fadeInUp">
                        <figure>
                           <div class="blog-img bg-extra-dark-gray">
                              <a href="blog-post-layout-01.html"><img src="    <?php
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">                                                        <?php
                                       $sql = "SELECT * FROM news;";
                                       $result = mysqli_query($conn, $sql);
                                       $resultCheck = mysqli_num_rows($result);
                                       ...
                                       ?> | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom">
                                       <a href="blog-post-layout-01.html" class="text-white">
                                       <?php
                                          $sql = "SELECT * FROM news;";
                                          $result = mysqli_query($conn, $sql);
                                          $resultCheck = mysqli_num_rows($result);
                                    ...
                                    <p class="text-medium-gray margin-10px-top width-80 md-width-100 blog-hover-text">    <?php
                                       $sql = "SELECT * FROM news;";
                                       $result = mysqli_query($conn, $sql);
                                       $resultCheck = mysqli_num_rows($result);
                              ...
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">                                                        <?php
                                       ...
                                       ?>| by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-05.html" class="text-white">The most beautiful sky</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        </figure>
                     ...
                     <li class="grid-item wow fadeInUp" data-wow-delay="0.4s">
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-02.html" class="text-white">I can't change the rule</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-03.html" class="text-white">Happiness is something</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-04.html" class="text-white">This is the secret of success</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-05.html" class="text-white">Clouds come floating life</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-01.html" class="text-white">Nothing is impossible</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-02.html" class="text-white">What lies behind you</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-03.html" class="text-white">Perfection is not attainable</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-04.html" class="text-white">The spirit of adventure</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-01.html" class="text-white">All you need is the plan</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
                        ...
                        <figure>
                           ...
                           <figcaption>
                              <div class="portfolio-hover-main text-left">
                                 <div class="blog-hover-box vertical-align-bottom">
                                    <span class="post-author text-extra-small text-medium-gray text-uppercase display-block margin-5px-bottom xs-margin-5px-bottom">25 April 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jay Benjamin</a></span>
                                    <h6 class="alt-font display-block text-white font-weight-600 no-margin-bottom"><a href="blog-post-layout-01.html" class="text-white">We know what we are</a></h6>
                                    <p class="text-medium-gray margin-10px-top width-80 sm-width-100 blog-hover-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                 </div>
                              </div>
                           </figcaption>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 widget sm-margin-30px-bottom xs-text-center">
                     ...
                     <p class="text-small width-95 xs-width-100 no-margin">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy
                        text of the and typesetting industry. 
                     </p>
                  </div>
                  <!-- end about -->
                  <!-- start blog post -->
   ...
   <!-- Mirrored from www.themezaa.com/html/pofo/home-blog-personal.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Aug 2018 08:07:42 GMT -->
</html>